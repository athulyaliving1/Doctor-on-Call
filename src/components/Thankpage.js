    ...
    <div>
      <section className="text-gray-600 body-font bg-zinc-100 ">
        <div className="container flex flex-wrap px-5 py-24 mx-auto ">
          <div className="w-full mb-10 overflow-hidden rounded-lg lg:w-1/2 lg:mb-0 xl:mt-10 xl:pb-5">
            <img
              alt="feature"
          ...
          <div className="grid content-center w-full gap-4 mb-10 overflow-hidden rounded-lg lg:w-1/2 lg:mb-0 xl:mt-10 ">
